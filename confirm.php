		        	...
		        	<div class="box_order_form">
		                ...
		                <div class="main">
		                	<div id="confirm">
                                ...
                                <p>Please check your email for your order details</p>
							</div>
		                </div>
		            </div>
		            <!-- /box_booking -->
...
<!----------------------------------------------------------------------------->
    <script>
		$(document).ready( function () {
            if(getCookie("promoCodeValue")){
			document.cookie = "promoCodeName= ; expires = Thu, 01 Jan 1970 00:00:00 GMT";
			document.cookie = "promoCodeValue= ; expires = Thu, 01 Jan 1970 00:00:00 GMT";
            }
		});
	</script>
    <script>
