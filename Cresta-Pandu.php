...
if(isset($_GET['prodExtra1Rem']) || isset($_GET['prodExtra2Rem'])){
	...
	header("Refresh:0; url=Cresta-Pandu.php");
}
...
<body data-spy="scroll" data-target="#secondary_nav" data-offset="75">
	...
	$product= mysqli_query($conn,"SELECT FLOOR(AVG(average)) as averages, COUNT(id) as ratings FROM reviews WHERE restaurant =  'Cresta Pandu Restaurant & Bar' ORDER BY id ASC");
	if (!empty($product)) { 
	...
	?> </div>
	                    <div class="title">
						<?php
	$product= mysqli_query($conn,"SELECT * FROM restaraunt WHERE id = '3004'");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {
	...
	<?php echo $row["address"]; ?> - <a href="<?php echo $row["maps"]; ?>" target="blank">Get directions</a>
		...
		?>
	                ...
	                <!-- /detail_page_head -->
					<br>
	                <h6>About "Cresta Pandu Restaurant & Bar"</h6>
	                <p>Located at Protea Hotel Ondangwa, Pandu restaurant is the ideal venue to unwind and create new memories over a scrumptious meal whilst sipping on a selection of our beverages. Alternatively, place an order and we will deliver a quality meal to your doorstep.</p>
	            </div>
	            <div class="col-lg-4">
	                <div class="pictures magnific-gallery clearfix">
	                    <figure>
	                        <a href="https://eatatunited.com.na/wp-content/uploads/2020/08/BeefStew.jpg" title="Photo title" data-effect="mfp-zoom-in">
	                            <img src="https://eatatunited.com.na/wp-content/uploads/2020/08/BeefStew.jpg" class="lazy loaded" alt="" data-was-processed="true">
	                        </a>
	                    </figure>
		...
		<nav class="secondary_nav sticky_horizontal">
	        <div class="container">
	            <ul id="secondary_nav">
	                ...
	                <li><a class="list-group-item list-group-item-action" href="#section-2">Pizza</a></li>
	                <li><a class="list-group-item list-group-item-action" href="#section-3">Burgers</a></li>
	                    ...
	                    <section id="section-1">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'main' && restID = '3004' ORDER BY id ASC");
	if (!empty($product)) {
	                    ...
	                    <section id="section-2">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'pizza' && restID = '3004' ORDER BY id ASC");
	if (!empty($product)) {
	                    ...
	                    <section id="section-3">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'burgers' && restID = '3004' ORDER BY id ASC");
	if (!empty($product)) { 
...
$cartProducts= mysqli_query($conn,"SELECT * FROM current_order WHERE user_id =".$user_id." ORDER BY id ASC");
	if (!empty($cartProducts)) { 
		while ($row=mysqli_fetch_array($cartProducts)) {
			...
			if($extrasel){
				if(strcasecmp($extrasel,$extraName1) == 0){
					echo '<tr>
				  <td style="text-align:left; "><a href="Cresta-Pandu.php?action=remove&code='.$rowID.'&prodExtra1Rem='.$extraName1.'&prodExtra2Rem='.$extraName2.'" class="btnRemoveAction"><img src="img/minus-sign.png" height="18px" alt=" " /></a></td>
		...
		?>
								...
								<ul class="clearfix">
									<br>
									<li><a id="btnEmpty" href="Cresta-Pandu.php?action=empty&empty=true">Empty Cart</a></li>
...
?>
								...
								<input type="hidden" name="restName" id="restName" value="Cresta Pandu Restaurant & Bar"/>
									</form>
	        ...
	        <div class="row">
	            <div class="col-lg-8 list_menu">
	                <section id="section-5">
	                    <h4>Reviews</h4>
						<?php
	$product= mysqli_query($conn,"SELECT * FROM reviews WHERE restaurant = 'Cresta Pandu Restaurant & Bar' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {
	                    ...
	                    <div class="row add_bottom_30 d-flex align-items-center reviews">
	                        <div class="col-md-3">
	                            <div id="review_summary">
	                                <em>Cresta Pandu Restaurant & Bar</em>
	                            </div>
	                        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm links" id="collapse_2">
                        <ul>
                            <li><a href="Cresta-Pandu.php">Katima Mulilo</a></li>
                            <li><a href="Cresta-Pandu.php">Ondangwa</a></li>
