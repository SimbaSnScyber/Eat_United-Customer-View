...
if(isset($_GET['prodExtra1Rem']) || isset($_GET['prodExtra2Rem'])){
	...
	header("Refresh:0; url=Neptune’s.php");
}
...
<body data-spy="scroll" data-target="#secondary_nav" data-offset="75">
	        ...
	        <div class="row">
	            <div class="col-lg-8">
	                <div class="detail_page_head clearfix">
	                    <div class="rating">
							<?php
	$product= mysqli_query($conn,"SELECT FLOOR(AVG(average)) as averages, COUNT(id) as ratings FROM reviews WHERE restaurant =  'Neptunes Coffee Shop' ORDER BY id ASC");
	if (!empty($product)) { 
	...
	?>
	                    ...
	                    <div class="title">
						<?php
	$product= mysqli_query($conn,"SELECT * FROM restaraunt WHERE id = '3003'");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {
		...
		?>  
	            ...
	            <div class="col-lg-4">
	                <div class="pictures magnific-gallery clearfix">
	                    <figure>
	                        <a href="https://eatatunited.com.na/wp-content/uploads/2020/08/DarkChocolate.jpg" title="Photo title" data-effect="mfp-zoom-in">
	                            <img src="https://eatatunited.com.na/wp-content/uploads/2020/08/DarkChocolate.jpg" class="lazy loaded" alt="" data-was-processed="true">
	                        </a>
	                    </figure>
		...
		<nav class="secondary_nav sticky_horizontal">
	        <div class="container">
	            <ul id="secondary_nav">
	                ...
	                <li><a class="list-group-item list-group-item-action" href="#section-2">Seafood Boils</a></li>					
	                <li><a class="list-group-item list-group-item-action" href="#section-3">Sandwiches & Wraps</a></li>
	                <li><a class="list-group-item list-group-item-action" href="#section-4">Sweet Corner</a></li>
	                    ...
	                    <section id="section-1">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'main' && restID = '3003' ORDER BY id ASC");
	if (!empty($product)) { 
	                    ...
	                    <section id="section-2">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'platter' && restID = '3003' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
	                    ...
	                    <section id="section-3">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'toesties' && restID = '3003' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
	                    ...
	                    <section id="section-4">
	                        ...
	                        <div class="table_wrapper">
								...
								<thead>
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'extras' && restID = '3003' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
...
$cartProducts= mysqli_query($conn,"SELECT * FROM current_order WHERE user_id =".$user_id." ORDER BY id ASC");
	if (!empty($cartProducts)) { 
		while ($row=mysqli_fetch_array($cartProducts)) {
			...
			if($extrasel){
				if(strcasecmp($extrasel,$extraName1) == 0){
					echo '<tr>
				  <td style="text-align:left; "><a href="Neptune’s.php?action=remove&code='.$rowID.'&prodExtra1Rem='.$extraName1.'&prodExtra2Rem='.$extraName2.'" class="btnRemoveAction"><img src="img/minus-sign.png" height="18px" alt=" " /></a></td>
		...
		?>
								...
								<ul class="clearfix">
									<br>
									<li><a id="btnEmpty" href="Neptune’s.php?action=empty&empty=true">Empty Cart</a></li>
...
?>
								...
								<input type="hidden" name="restName" id="restName" value="Neptunes Coffee Shop"/>
									</form>
	        ...
	        <div class="row">
	            <div class="col-lg-8 list_menu">
	                <section id="section-5">
	                    <h4>Reviews</h4>
	                    <?php
	$product= mysqli_query($conn,"SELECT * FROM reviews WHERE restaurant = 'Neptunes Coffee Shop' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {
