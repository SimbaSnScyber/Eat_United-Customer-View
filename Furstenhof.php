...
if(isset($_GET['prodExtra1Rem']) || isset($_GET['prodExtra2Rem'])){
	$delete_query = "DELETE FROM current_order WHERE id =".$_GET['code']." AND user_id =".$user_id;
	$result = mysqli_query($conn,$delete_query);
	header("Refresh:0; url=Furstenhof.php");
}
...
if(isset($_POST['add'])){
	...
	$insert_query = "INSERT INTO current_order (user_id, prodID, prodName, prodExtra1, prodExtra2, prodPrice, quantity) VALUES('".$user_id."','".$prodID."','".$prodName."','".$prodExtra1."','".$prodExtra2."','".$prodPrice."', '1')";
...
<body data-spy="scroll" data-target="#secondary_nav" data-offset="75">
	        ...
	        <div class="row">
	            <div class="col-lg-8">
	                <div class="detail_page_head clearfix">
	                    <div class="rating">
						<?php
	$product= mysqli_query($conn,"SELECT FLOOR(AVG(average)) as averages, COUNT(id) as ratings FROM reviews WHERE restaurant = 'Furstenhof Restaurant & Bar'");
	if (!empty($product)) { 
	...
	<?php echo $row["address"]; ?> - <a href="<?php echo $row["maps"]; ?>" target="blank">Get directions</a>
		...
		?>
	                ...
	                <!-- /detail_page_head -->
					<br>
	                <h6>About "Furstenhof Restaurant & Bar"</h6>
	                <p>Furstenhof Restaurant & Bar is located in the Windhoek CBD at the 4* Protea Hotel by Marriott Windhoek Furstenhof. Our intimate restaurant setting combined with a delightful menu caters to Families, Tourists and Corporates. You can also quench your thirst at our Bar with a cocktail or two whilst watching the beautiful Namibian sunset.</p>
	            </div>
	            <div class="col-lg-4">
	                <div class="pictures magnific-gallery clearfix">
	                    <figure>
	                        <a href="https://eatatunited.com.na/wp-content/uploads/2020/11/Pasta.jpg" title="Photo title" data-effect="mfp-zoom-in">
	                            <img src="https://eatatunited.com.na/wp-content/uploads/2020/11/Pasta.jpg" class="lazy loaded" alt="" data-was-processed="true">
	                        </a>
	                    </figure>
						<figure><a href="img/detail_gallery/detail_5.jpg" title="Photo title" data-effect="mfp-zoom-in"><span class="d-flex align-items-center justify-content-center">+1</span><img src="img/thumb_detail_5.jpg" data-src="img/thumb_detail_5.jpg" class="lazy loaded" alt="" data-was-processed="true"></a></figure>
	                </div>
	            </div>
	        </div>
	        <!-- /row -->
		...
		<nav class="secondary_nav sticky_horizontal">
	        <div class="container">
	            <ul id="secondary_nav">
	                <li><a class="list-group-item list-group-item-action" href="#section-1">Main Courses</a></li>
	                <li><a class="list-group-item list-group-item-action" href="#section-2">Platters</a></li>
	                <li><a class="list-group-item list-group-item-action" href="#section-3">On the side</a></li>
	...
	$order= mysqli_query($conn,"SELECT prodID FROM orders WHERE userID = 0 ORDER BY id DESC LIMIT 1");
	if (!empty($order)) { 
		while ($row1=mysqli_fetch_array($order)) {	
	$prodId	= $row1["prodID"];
	$product= mysqli_query($conn,"SELECT * FROM products WHERE restID = '3001' && id = 0 ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
			...
			echo '
					<section id="section-1">
	                        <h4>Main Courses</h4> <div class="table_wrapper">
	...
	?>
						...
						<section id="section-1">
	                        <h4>Main Courses</h4><?php if(!isset($_SESSION['id'])){echo '</br><h6 style="color:red">***Attention***</h6></br><h6 style="color:red">Please sign in using the navigation button at the top of the page before proceeding to order or the order will not be processed</h6>';}?>
	                        <div class="table_wrapper">
	                            <table class="table cart-list menu-gallery">
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'main' && restID = '3001' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
	                    ...
	                    <section id="section-2">
	                        ...
	                        <div class="table_wrapper">
	                            <table class="table cart-list menu-gallery">
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'platter' && restID = '3001' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
						...
						<section id="section-3">
	                        ...
	                        <div class="table_wrapper">
	                            <table class="table cart-list menu-gallery">
	                                ...
	                                <tbody>
									<?php
	$product= mysqli_query($conn,"SELECT * FROM products WHERE category = 'extra' && restID = '3001' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {	
...
$cartProducts= mysqli_query($conn,"SELECT * FROM current_order WHERE user_id =".$user_id." ORDER BY id ASC");
	if (!empty($cartProducts)) { 
		while ($row=mysqli_fetch_array($cartProducts)) {
			...
			if($extrasel){
				if(strcasecmp($extrasel,$extraName1) == 0){
					echo '<tr>
				  <td style="text-align:left; "><a href="Furstenhof.php?action=remove&code='.$rowID.'&prodExtra1Rem='.$extraName1.'&prodExtra2Rem='.$extraName2.'" class="btnRemoveAction"><img src="img/minus-sign.png" height="18px" alt=" " /></a></td>
		...
		?>
								...
								<ul class="clearfix">
									<br>
									<li><a id="btnEmpty" href="Furstenhof.php?action=empty&empty=true">Empty Cart</a></li>
...
?>
								...
								<input type="hidden" name="restName" id="restName" value="Furstenhof Restaurant & Bar"/>
									</form>
	        ...
	        <div class="row">
	            <div class="col-lg-8 list_menu">
	                <section id="section-5">
	                    <h4>Reviews</h4>
						<?php
	$product= mysqli_query($conn,"SELECT * FROM reviews WHERE restaurant = 'Furstenhof Restaurant & Bar' ORDER BY id ASC");
	if (!empty($product)) { 
		while ($row=mysqli_fetch_array($product)) {
	                    ...
	                    <div class="row add_bottom_30 d-flex align-items-center reviews">
	                        <div class="col-md-3">
	                            <div id="review_summary">
	                                <em>Furstenhof Restaurant & Bar</em>
	                            </div>
	                        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm links" id="collapse_2">
                        <ul>
                            <li><a href="Tafule-Yaka .php">Katima Mulilo</a></li>
                            <li><a href="Furstenhof.php">Ondangwa</a></li>
                            <li><a href="Neptune’s.php">Walvis Bay</a></li>
                            <li><a href="Top-Restaurant .php">Windhoek</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
