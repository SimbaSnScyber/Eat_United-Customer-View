	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Marker': [
			{
				...
				location_latitude: -22.5604821,
				location_longitude: 17.0817825,
				map_image_url: 'img/thumb_map_single_restaurant.jpg',
				name_point: 'Furstenhof Restaurant & Bar',
				get_directions_start_address: 'https://goo.gl/maps/BFUb8dWrimZFJiSn6',
				phone: '+264-61-237 380',
				url_point: 'Furstenhof.php'
			},
			{
				name: 'Top Restaurant and Bar',
				location_latitude: -22.566078051918023, 
				location_longitude: 17.078594968694564, 
				map_image_url: 'img/thumb_map_single_restaurant.jpg',
				name_point: 'Top Restaurant and Bar',
				get_directions_start_address: 'https://goo.gl/maps/GxCZsYQNpsUaR3zM6',
				phone: '+264-61- 226031',
				url_point: 'Top-Restaurant .php'
			},
			{
				name: 'Tafule Yaka Restaurant & Bar',				
				location_latitude: -17.490285,
				location_longitude: 24.2801733,
				map_image_url: 'img/thumb_map_single_restaurant.jpg',
				name_point: 'Tafule Yaka Restaurant & Bar',
				get_directions_start_address: 'https://goo.gl/maps/Bht8n81uxZrsUnFq7',
				phone: '+264-66-251500',
				url_point: 'Tafule-Yaka .php'
			},
			{
				name: 'Neptune’s Coffee Shop',
				location_latitude: -22.9702524,
				location_longitude: 14.486171,
				map_image_url: 'img/thumb_map_single_restaurant.jpg',
				name_point: 'Neptune’s Coffee Shop',
				get_directions_start_address: 'https://goo.gl/maps/dJABhgwrK6z3bfGa9',
				phone: '+264-64-214000',
				url_point: 'Neptune’s.php'
			},
			{
				name: 'Cresta Pandu Restaurant & Bar',
				location_latitude: -17.9021115,
				location_longitude: 15.9386722,
				map_image_url: 'img/thumb_map_single_restaurant.jpg',
				name_point: 'Cresta Pandu Restaurant & Bar',
				get_directions_start_address: 'https://goo.gl/maps/BFUb8dWrimZFJiSn6',
				phone: '+264-65-241900',
				url_point: 'Cresta-Pandu.php'
			}
			]
			...
			var mapOptions = {
				zoom: 6.5,
				center: new google.maps.LatLng(-20.047502, 19.452447),
